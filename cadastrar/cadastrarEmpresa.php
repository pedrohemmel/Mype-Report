    ...
    <main>
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="displayFlex flex-direction-row justify-content-center">
                ...
                <input type="text" name="cor_pri_emp" minLength="6" maxLength="6" placeholder="Cor primária">
                <label>Cor Secundária da empresa</label>
                <input type="text" name="cor_sec_emp" minLength="6" maxLength="6" placeholder="Cor secundária">
            </div>
            <br><br>
